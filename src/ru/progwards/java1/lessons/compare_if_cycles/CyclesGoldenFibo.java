...
public class CyclesGoldenFibo {
    ...
    public static boolean isGoldenTriangle(int a, int b, int c) {
        if ((a == b) & (((double) a / c >= 1.6170) & ((double) a / c <= 1.61903))) return true;
        if ((a == c) & (((double) a / b >= 1.6170) & ((double) a / b <= 1.61903))) return true;
        if ((c == b) & (((double) c / a >= 1.6170) & ((double) c / a <= 1.61903))) return true;
        return false;
    }
